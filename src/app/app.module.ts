...
@NgModule({
  ...
  imports: [
    BrowserModule,
    AppRoutingModule,
    BrowserAnimationsModule, //animações; exemplo: expansões
    HttpClientModule, // interação com apis
    FormsModule, //para criação e gerenciamento de formularios
    FontAwesomeModule, // para uso de icones
    FormsModule,
  ],
  providers: [],
